...
export default function LogoNoBg() {
  return (
    <>
      <svg
      ...
      >
        <g transform="matrix(1,0,0,1,-0.6060606060606233,0.26074224495451404)">
          <svg
            viewBox="0 0 396 109"
          ...
          >
            <g
              id="tight-bounds"
              transform="matrix(1,0,0,1,0.2400000000000091,-0.10334874436378527)"
            >
              <svg
                viewBox="0 0 395.52 109.20669748872758"
                height="109.20669748872758"
                width="395.52"
              >
                <g>
                  <svg
                    viewBox="0 0 582.6187913497113 160.86638880000004"
                    height="109.20669748872758"
                    width="395.52"
                  >
                    <g transform="matrix(1,0,0,1,0,24.87396231009835)">
                      <svg
                        viewBox="0 0 395.52 111.11846417980334"
                        height="111.11846417980334"
                        width="395.52"
                      >
                        <g>
                          <svg
                    ...
                    <g transform="matrix(1,0,0,1,421.75240254971123,0)">
                      <svg
                        viewBox="0 0 160.86638880000004 160.86638880000004"
                        height="160.86638880000004"
                        width="160.86638880000004"
                      >
                        <g>
                          <svg></svg>
                        </g>
                        <g id="icon-0">
                          ...
                          >
                            <g>
                              <rect
                                width="146.26925352000003"
                                height="146.26925352000003"
                                x="7.298567640000002"
                                y="7.298567640000002"
                                fill="#fe6d1c"
                            ...
                            <g transform="matrix(1,0,0,1,38.47067517209872,20.853050400000008)">
                              <svg
                                viewBox="0 0 83.92503845580259 119.16028800000002"
                                height="119.16028800000002"
                                width="83.92503845580259"
                              >
                                <g>
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    x="0"
                                    y="0"
                                    viewBox="24.658000946044922 14.017998695373535 50.68522262573242 71.96500396728516"
                                  ...
                                  >
                                    ...
                                    >
                                      <path
                                        d="M75.247 41.843c-0.715-6.531-5.452-13.034-13-17.843-7.463-4.753-7.605-9.219-7.605-9.405v-0.577h-5.998v50.392c-2.51-1.511-5.615-2.416-8.995-2.416-8.28 0-14.991 5.369-14.991 11.995 0 6.623 6.711 11.994 14.991 11.994 8.278 0 14.993-5.371 14.993-11.994V30.72c1.197 0.938 2.625 1.753 4.386 2.337 14.478 4.824 13.587 20.052 10.728 22.915C73.908 51.82 75.808 46.934 75.247 41.843z"
                                        fill="#ffffff"
                                        data-fill-palette-color="background"
                                      ></path>
                                    </g>
                                    ...
                                    >
                                      <path
                                        display="inline"
                                        d="M76.637 18.634c0-2.52-2.053-4.569-4.57-4.569H27.941c-2.521 0-4.574 2.05-4.574 4.569l-3.891 28.78h0.01V75.43h2.506v10.506h9.336V75.43h37.346v10.506h9.336V75.43h2.502V47.414h0.012L76.637 18.634zM41.25 17.337h17.508v5.123H41.25V17.337zM31.143 67.257c-3.217 0-5.832-2.611-5.832-5.833 0-3.226 2.615-5.835 5.832-5.835 3.23 0 5.84 2.609 5.84 5.835C36.982 64.646 34.373 67.257 31.143 67.257zM68.855 67.257c-3.223 0-5.832-2.611-5.832-5.833 0-3.226 2.609-5.835 5.832-5.835s5.836 2.609 5.836 5.835C74.691 64.646 72.078 67.257 68.855 67.257zM25.311 46.155l3.893-20.424h41.6l3.889 20.424H25.311z"
                                        fill="#ffffff"
                                        data-fill-palette-color="background"
                                      ></path>
                                    </g>
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        ></circle>
                                        <path
                                          d="M15.519 39.506v11.992c18.186 0 32.983 14.797 32.983 32.984h11.994C60.496 59.682 40.314 39.506 15.519 39.506z"
                                          fill="#ffffff"
                                          data-fill-palette-color="background"
                                        ></path>
                                        <path
                                          d="M15.519 15.518v11.994c31.413 0 56.968 25.556 56.968 56.971h11.995C84.481 46.456 53.546 15.518 15.519 15.518z"
                                          fill="#ffffff"
                                          data-fill-palette-color="background"
                                        ></path>
                                      </g>
                                    ...
                                    >
                                      <polygon
                                        display="inline"
                                        points="54.914,36.953 63.789,45.894 78.459,31.087 86,38.856 85.992,15 78.537,15 62.141,15    69.602,22.337  "
                                        fill="#ffffff"
                                        data-fill-palette-color="background"
                                      ></polygon>
                                      <polygon
                                        display="inline"
                                        points="64,73 27,73 27,37 45.734,37 60.254,22 14,22 14,86 77,86 77,40.089 64,55.39  "
                                        fill="#ffffff"
                                        data-fill-palette-color="background"
                                      ></polygon>
                                    </g>
